...
from Test_Fold.utils.embedding import *
from Test_Fold.utils.label_embedding import *
...
param = torch.load('./8batchWModelState5.pth')
...
model = TagModel150(4, Block, 2).to(device)

model.load_state_dict(param)

devset = IntelDNADataset('./dataset_full', 'train')
